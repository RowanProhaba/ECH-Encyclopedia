...
jQuery(document).ready(function(){
    ...
    var currentPage = jQuery(".ech-encyclopedia-pagination").data("current-page");
...
function paginationGenerate(page){
    ...
    var maxPage = jQuery(".ech-encyclopedia-pagination").data("max-page");
    ...
    jQuery('.ech-encyclopedia-pagination ul').remove();
    jQuery('.ech-encyclopedia-pagination').append(pagination);
    
    // change data-current-page value
    jQuery(".ech-encyclopedia-pagination").data("current-page", page);
    jQuery(".ech-encyclopedia-pagination").attr("data-current-page", page);
